...
# )
# from src.config import ENV_CONFIG, SERVER_CONFIGS, MAB_CONFIG, PPO_CONFIG
...
#     )
#     parser.add_argument(
#         "--history", type=int, default=5, help="History length for RL state"
#     )
...
#     )
#     parser.add_argument(
#         "--workload_size", type=int, default=500, help="Number of requests in workload"
#     )
...
#         agents["PPO"] = PPOAgent(
#             num_servers=env.num_servers, state_dim=state_dim, **PPO_CONFIG
#         )
...
#             env.render()
#             print(
#                 f"Step {step}, Latency: {info['latency']:.4f}, Throughput: {info['throughput']:.4f}"
#             )
...
#             agent_metrics.server_utilizations.extend(
#                 episode_metrics.server_utilizations
#             )
...
#     latency_comparison = {
#         name: metrics.latencies for name, metrics in all_metrics.items()
#     }
#     throughput_comparison = {
#         name: metrics.throughputs for name, metrics in all_metrics.items()
#     }
...
#             workloads = {
#                 "Uniform": workload_gen.uniform_workload(
#                     num_requests=args.workload_size
#                 )
#             }
...
#             workloads = {
#                 "Diurnal": workload_gen.diurnal_workload(
#                     num_requests=args.workload_size
#                 )
#             }
...
#         # Extract data for comparison plots
#         latency_comparison = {
#             name: metrics.latencies for name, metrics in workload_results.items()
#         }
#         throughput_comparison = {
#             name: metrics.throughputs for name, metrics in workload_results.items()
#         }

#         # Generate comparison plots
#         plot_latency_comparison(
#             latency_comparison, title=f"Latency Comparison - {workload_name} Workload"
#         )
#         plot_throughput_comparison(
#             throughput_comparison,
...
#             "alpha": [0.05, 0.1, 0.2],
#         },
#         BanditStrategy.UCB: {"ucb_c": [0.5, 1.0, 2.0, 4.0], "alpha": [0.05, 0.1, 0.2]},
#         BanditStrategy.THOMPSON_SAMPLING: {"alpha": [0.05, 0.1, 0.2]},
#     }
...
#                 num_servers=env.num_servers, strategy=strategy, **config
#             )
...
#     print(
#         "Hyperparameter tuning complete. Results saved to 'results/hyperparameter/' directory."
#     )
...
#         episode_metrics = run_episode(
#             env, ppo_agent, max_steps=args.steps, render=False
#         )

#         # Track average latency for this episode
#         avg_latency = (
#             np.mean(episode_metrics.latencies) if episode_metrics.latencies else 0
#         )
...
#         for episode in range(args.episodes):
#             episode_metrics = run_episode(
#                 env, agent, max_steps=args.steps, render=(episode == 0)
#             )
...
#     plot_throughput_comparison(
#         throughput_comparison, title="Throughput Comparison with PPO"
#     )
